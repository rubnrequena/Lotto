...
--topes_usuario
SELECT creado, topes.usuarioID, topes.bancaID, topeID, monto, topes.taquillaID, taquillas.nombre "taquilla", sorteos.descripcion, topes.sorteo, topes.sorteoID, numeros.descripcion elemento, numeros.elementoID num, compartido 
FROM us.topes 
LEFT JOIN us.taquillas ON taquillas.taquillaID = topes.taquillaID 
LEFT JOIN vt.sorteos ON sorteos.sorteoID = topes.sorteoID 
LEFT JOIN numeros ON numeros.elementoID = topes.elemento 
